		...
		<div class="card-body">
			<table class="table tabe-hover table-bordered" id="list">
				...
				<tbody>
					...
					$qry = $conn->query("SELECT *,concat(firstname,' ',lastname) as name FROM evaluator_list order by concat(firstname,' ',lastname) asc");
...
<script>
	...
	$('.view_evaluator').click(function(){
		uni_modal("<i class='fa fa-id-card'></i> evaluator Details","<?php echo $_SESSION['login_view_folder'] ?>view_evaluator.php?id="+$(this).attr('data-id'))
	})
